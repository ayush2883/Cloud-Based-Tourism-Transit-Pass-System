...
if (isset($_POST['name'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO pass (name, email, contact, date, dest, password) VALUES (?, ?, ?, ?, ?, ?)");
    ...
    if ($row = $result->fetch_assoc()) {
        ...
        // For example, you can set a default price or redirect to an error page
        // $amt = 0;
        // Redirect to error page: header("Location: error.php");
    }
    $stmt->close();
}
?>
...
@media (max-width: 800px) {
  ...
  <div class="site-blocks-cover overlay" style="background-image: url(images/bus.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
  ...
  <div class="col-75">
    ...
    if ($result) {
        ...
        if ($result->num_rows > 0) {
            ...
            // Handle the situation when destination not found
            // For example, set a default price or redirect to an error page
            // $amt = 0;
            // Redirect to error page: header("Location: error.php");
        }
    } else {
        // Handle the database query error if any
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-5">
              ...
              <p>Provides student a pass for their daily life to travel to/from AITR, Indore</p>
            </div>
